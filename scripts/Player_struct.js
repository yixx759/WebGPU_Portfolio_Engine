...
export function Set_Up_Objects()
{
    ...
    let playerObject = new objectInfo.gameObject(PLAYER_ID, PLAYER_MODEL_INDEX, PLAYER_TEXTURE_INDEX, PLAYER_START_POSITION, PLAYER_START_SCALE, PLAYER_START_ROTATION, helper.ZEROS, helper.ZEROS_MATRIX, BRDF_configs.BASIC_INDEX);
    ...
    let otherObject = new objectInfo.gameObject(OTHER_ID, OTHER_MODEL_INDEX, OTHER_TEXTURE_INDEX, OTHER_START_POSITION, OTHER_START_SCALE, OTHER_START_ROTATION, helper.ZEROS, helper.ZEROS_MATRIX, BRDF_configs.BASIC_INDEX);
    ...
    let wall_1 = new objectInfo.gameObject(WALL_1_ID, WALL_1_MODEL_INDEX, WALL_1_TEXTURE_INDEX, WALL_1_START_POSITION, WALL_1_START_SCALE, WALL_1_START_ROTATION, helper.ZEROS, helper.ZEROS_MATRIX, BRDF_configs.BASIC_INDEX);
    ...
    let wall_2 = new objectInfo.gameObject(WALL_2_ID, WALL_2_MODEL_INDEX, WALL_2_TEXTURE_INDEX, WALL_2_START_POSITION, WALL_2_START_SCALE, WALL_2_START_ROTATION, helper.ZEROS, helper.ZEROS_MATRIX, BRDF_configs.BASIC_INDEX);
    ...
    let wall_3 = new objectInfo.gameObject(WALL_3_ID, WALL_3_MODEL_INDEX, WALL_3_TEXTURE_INDEX, WALL_3_START_POSITION, WALL_3_START_SCALE, WALL_3_START_ROTATION, helper.ZEROS, helper.ZEROS_MATRIX, BRDF_configs.BASIC_INDEX);
    ...
    let wall_4 = new objectInfo.gameObject(WALL_4_ID, WALL_4_MODEL_INDEX, WALL_4_TEXTURE_INDEX, WALL_4_START_POSITION, WALL_4_START_SCALE, WALL_4_START_ROTATION, helper.ZEROS, helper.ZEROS_MATRIX, BRDF_configs.BASIC_INDEX);
    ...
    let wall_5 = new objectInfo.gameObject(WALL_5_ID, WALL_5_MODEL_INDEX, WALL_5_TEXTURE_INDEX, WALL_5_START_POSITION, WALL_5_START_SCALE, WALL_5_START_ROTATION, helper.ZEROS, helper.ZEROS_MATRIX, BRDF_configs.BASIC_INDEX);
    ...
    let wall_6 = new objectInfo.gameObject(WALL_6_ID, WALL_6_MODEL_INDEX, WALL_6_TEXTURE_INDEX, WALL_6_START_POSITION, WALL_6_START_SCALE, WALL_6_START_ROTATION, helper.ZEROS, helper.ZEROS_MATRIX, BRDF_configs.BASIC_INDEX);
